...
launcher = 'none'
load_from = 'work_dirs/b0_rnnB1_160k_v2/iter_160000.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '/workspace/mgr_segformer_playground/results/cityscapes/1024x1024/vis/B0_RNN_160k',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = './work_dirs/segformer_mit-b0_rnnB1_160k_cityscapes-1024x1024'
