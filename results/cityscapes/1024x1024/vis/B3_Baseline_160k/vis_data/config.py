...
launcher = 'none'
load_from = 'work_dirs/b3_baseline_160k/iter_160000.pth'
log_level = 'INFO'
...
visualizer = dict(
    name='visualizer',
    save_dir=
    '/workspace/mgr_segformer_playground/results/cityscapes/1024x1024/vis/B3_Baseline_160k',
    type='SegLocalVisualizer',
    vis_backends=[
        dict(type='LocalVisBackend'),
    ])
work_dir = './work_dirs/segformer_mit-b3_8xb1-160k_cityscapes-1024x1024'
